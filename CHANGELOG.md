...
* align section header font sizes in transaction detail page ([eedf033](https://github.com/qubic/explorer-frontend/commit/eedf03307c36f6409f2feabfd67e48122dd1016a))
* convert event timestamps from epoch seconds to milliseconds ([69c6b97](https://github.com/qubic/explorer-frontend/commit/69c6b973792cd60cf7c7ff44ff959782c87d8a62))
* correct stale timestamp comment in event types ([394052c](https://github.com/qubic/explorer-frontend/commit/394052c5790cb830a042cb32270fc019f9d1ffbb))
* decode shares auction bids without SDK contract decoder ([ba8125c](https://github.com/qubic/explorer-frontend/commit/ba8125c64a63ba0bf561e5a5f6619df8ba12a76f))
* decode unitOfMeasurement from base64 and show contract names in event details ([380531f](https://github.com/qubic/explorer-frontend/commit/380531f4f1766896ee5dc3acdd6dca4f41f09029))
* default tokens page to "standard" category instead of "all" ([d658485](https://github.com/qubic/explorer-frontend/commit/d6584854741dbdf9ed16eef22e3f2aa2a0773a38))
* handle null tickData in search bar for empty ticks ([ad47b62](https://github.com/qubic/explorer-frontend/commit/ad47b62628588d37ca7a17246e79d120a4341879))
* **i18n:** remove unused "type" translation key from all locales ([2a34b99](https://github.com/qubic/explorer-frontend/commit/2a34b99158da85751898be16a6402405cb2cee77))
* improve keyboard accessibility across UI components ([1cc06aa](https://github.com/qubic/explorer-frontend/commit/1cc06aadc996b19f44566ab30a4bff5b1075faed))
* make event amount optional to avoid misleading values for non-transfer events ([a97832b](https://github.com/qubic/explorer-frontend/commit/a97832b3ed89e3eaf4d451d5a5eb0ccb3f5cb883))
* move direction filter inside mobile modal and add address validation for events ([120a5da](https://github.com/qubic/explorer-frontend/commit/120a5da9f9d476e0d47ed3910b9c2da130780469))
* optimize TickPage tab memo to depend on tab param only ([73d4530](https://github.com/qubic/explorer-frontend/commit/73d4530f0ba1125fa6b69f701d44f0c36a2fcd66))
* prevent events tab from losing data on tick navigation ([8d3c87e](https://github.com/qubic/explorer-frontend/commit/8d3c87e6f006498507af62698c0f31a130efd480))
* remove card wrapper from event detail page to match transaction detail styling ([61049d8](https://github.com/qubic/explorer-frontend/commit/61049d8af39d10f261b7f879afd4aa5be88ed227))
* remove client-side timestamp conversion for events ([b58bcb6](https://github.com/qubic/explorer-frontend/commit/b58bcb64be4bc2bc6bc57722d4e253b3070609c6))
* remove incorrect role="button" from Link components ([c032d48](https://github.com/qubic/explorer-frontend/commit/c032d48b8dc861ddb73bc77c0cfdf5789f6e7965))
* remove source address override for contract reserve deduction events ([dd941b6](https://github.com/qubic/explorer-frontend/commit/dd941b69f0f72fa147ef4369a71fd510b7b043b2))
* remove validForTick display from tick events page ([e1f4d51](https://github.com/qubic/explorer-frontend/commit/e1f4d51058be6f2910bdbf7ed4ed2064b3c4fbe6))
* remove validForTick display from transaction detail pages ([fe24c6c](https://github.com/qubic/explorer-frontend/commit/fe24c6c4197a3a6bb2fa0e7097080f2eda545782))
* rename eventType to logType for getEvents API endpoint ([4d9de48](https://github.com/qubic/explorer-frontend/commit/4d9de48d9ae3ab9321ea5d455c73b07d076c41a3))
* rename managing contract label to Managing Contract Index ([f716b04](https://github.com/qubic/explorer-frontend/commit/f716b04ffe68cdeaa65c3a91d906b49b40c18ce6))
* reset error boundary on route change to prevent sticky white pages ([fc80c1d](https://github.com/qubic/explorer-frontend/commit/fc80c1de2e964def097bcb1bedcbe55fe7946ec2))
* resolve rebase conflicts and fix event timestamp parsing ([04dd819](https://github.com/qubic/explorer-frontend/commit/04dd819a433553f0e6126e91e3f06d77f962017d))
* show token issuer as single localized label ([82737dc](https://github.com/qubic/explorer-frontend/commit/82737dc73dba34cc5ae7c1132cac72087ea7443f))
* skip address name lookups for empty string addresses ([6283706](https://github.com/qubic/explorer-frontend/commit/62837067f9fc88e8eab36423a71d460feb4b57b9))
* translate blockchain for non-Latin script locales ([da25d5c](https://github.com/qubic/explorer-frontend/commit/da25d5c9c5c74154164f2eb401338f9e49bd044a))
* translate txType, status, and txID across all locales ([a9e6d5b](https://github.com/qubic/explorer-frontend/commit/a9e6d5b8793ed589da23ea70411501c62c3f283d))
* unify numeric formatting in decoded input table ([2366e66](https://github.com/qubic/explorer-frontend/commit/2366e666bc1c3049daa96aa23a3491c68846bdaa))
* use console.error instead of console.log in TxItem catch blocks ([e5b5f94](https://github.com/qubic/explorer-frontend/commit/e5b5f944561d68117165e86e099faf8776b37112))
* use ISO date format in table timestamps ([3ddd73f](https://github.com/qubic/explorer-frontend/commit/3ddd73f10b3cd060de4c9b4ac729858918ea7a36))
* wrap events filter bar on narrow screens ([81c0b17](https://github.com/qubic/explorer-frontend/commit/81c0b17d5128c1908f6829d577e54d46906aaeaa))


### Features

* add amount filter to events with asset type support (QUBIC, Other, Any) ([23e116a](https://github.com/qubic/explorer-frontend/commit/23e116a3e2777a0df4472da00b841ae0e828446b))
* add BETA disclaimer banner to events views ([5336949](https://github.com/qubic/explorer-frontend/commit/53369499d6d8b695f7afddcb365efe52da5df75b))
* add blockchain events page with server-side pagination and filtering ([cadfdae](https://github.com/qubic/explorer-frontend/commit/cadfdae919eec1512b64731b5e411eca5f73d531))
* add burns & deductions tab on smart contract address pages ([a610c56](https://github.com/qubic/explorer-frontend/commit/a610c56597eac956e101c97991616ee1c56e01de))
* add clickable virtual TX IDs with reduced detail view ([6b8d5f6](https://github.com/qubic/explorer-frontend/commit/6b8d5f60be098afd0109ea199b9919bb9815622c))
* add direction filter to address events tab ([666d2ad](https://github.com/qubic/explorer-frontend/commit/666d2ad1fb319c1815225b33e693ef0fd9689107))
* add epoch utility and display epoch in transaction details ([71f291b](https://github.com/qubic/explorer-frontend/commit/71f291b7d8e0289528a3ae3ae995a781e9c63654))
* add event detail page with clickable event IDs ([4e45ef9](https://github.com/qubic/explorer-frontend/commit/4e45ef9358540fe161bd36f203e2c6f5ccc95a98))
* add event type filter, shared BetaBanner, and tick navigation improvements ([ebf05b1](https://github.com/qubic/explorer-frontend/commit/ebf05b18be4b62219e105d49f3e0a51ae6cfed62))
* add last-processed-tick error handling and validForTick display ([80b5086](https://github.com/qubic/explorer-frontend/commit/80b508683634e7e23afda8730277a3d647ecc17e))
* add mock events UI to tick and address pages ([7bf1a7c](https://github.com/qubic/explorer-frontend/commit/7bf1a7c3241fa61f8fe3195e6cccc4e91f88fc17))
* add multi-select event type filtering with up to 5 selections ([bef81af](https://github.com/qubic/explorer-frontend/commit/bef81afc0717b2522e2daf11bc100c83a541e61f))
* add pagination to transaction details events list ([6c2add2](https://github.com/qubic/explorer-frontend/commit/6c2add2cefa9ab7a66631fa1498cb167729a77b1))
* add protocol transaction input decoding with formatted display ([346e577](https://github.com/qubic/explorer-frontend/commit/346e57781267aced7e5ac08c3098215f70612214))
* add protocol.json endpoint and transaction type display utilities ([c7c240b](https://github.com/qubic/explorer-frontend/commit/c7c240b60db5fb25253461b23645efb5c74cef16))
* add shares auction bid detection and input data decoder ([99b449c](https://github.com/qubic/explorer-frontend/commit/99b449cbff35a305498bb46a8ca1dda2e021f494))
* add styled tooltip on computor heatmap cells ([551bad2](https://github.com/qubic/explorer-frontend/commit/551bad254088375248d7cfa8362dd979a77e8771))
* add support for event types 11/12 (asset managing contract changes) ([d36e631](https://github.com/qubic/explorer-frontend/commit/d36e6310ed2a4f5a6be90ddbd86087b71aa2f8d9))
* add value type detection and numeric formatting to decoded input table ([13c435a](https://github.com/qubic/explorer-frontend/commit/13c435a0dca459c2259f23eef39dc3846f0bf8d3))
* add virtual transaction IDs for system event categories ([dd16021](https://github.com/qubic/explorer-frontend/commit/dd16021f594aa5cbf61e37011792fc5c87cc6c12))
* **address:** add TX Type filter with SC/procedure selection ([5771588](https://github.com/qubic/explorer-frontend/commit/577158809e637a9a9c3310335f5cc83ae128943d))
* align mock events data structure with Elasticsearch index template ([f825350](https://github.com/qubic/explorer-frontend/commit/f8253507c2c3554504cdcf67f6a8a4a98a56d061))
* expand event type filters and rename API params to logType ([c9b1da3](https://github.com/qubic/explorer-frontend/commit/c9b1da394435d8ef290ed0416d2790c04b83bee8))
* generate mock events from transaction data and delete static mock JSON ([4dc0eae](https://github.com/qubic/explorer-frontend/commit/4dc0eaebf12b5f78bf07ca95716a40cb34861a5a))
* improve events table UI and unify page sizes ([f6a4d57](https://github.com/qubic/explorer-frontend/commit/f6a4d57598a18cb3f890f86814d9eb73e68f6446))
* integrate real events API with server-side pagination and filtering ([bdbf9dd](https://github.com/qubic/explorer-frontend/commit/bdbf9ddc8ae8350ada35c1b4167240738811d798))
* merge mock transaction events UI into tick-transactions-table ([a817378](https://github.com/qubic/explorer-frontend/commit/a8173783a8aed6a0915f27c483b9284f145342b4))
* merge remove-historical-tab and sync address tabs URL ([a3d8b3f](https://github.com/qubic/explorer-frontend/commit/a3d8b3fb9fe6726e8bdb02586d769dedde7cf2d8))
* migrate events API from getEvents to getEventLogs endpoint ([e3076ca](https://github.com/qubic/explorer-frontend/commit/e3076cad5e4147bc519b4804171a8aa80a4cee14))
* persist tick transactions pagination state in URL ([c652e11](https://github.com/qubic/explorer-frontend/commit/c652e11c051150aadd81eee5359413a7c214256d))
* resolve address names in events table rows ([c4055f7](https://github.com/qubic/explorer-frontend/commit/c4055f75d31221654b55e1e39795b0144d6957cd))
* show +/- sign on amounts in address page transactions and events ([3f3fc7c](https://github.com/qubic/explorer-frontend/commit/3f3fc7c29f86484fdc021f22410ba2ec26eca0e3))
* show limit message when events reach 10,000 results ([7e7f6f4](https://github.com/qubic/explorer-frontend/commit/7e7f6f486496aeffe365038b8b173e89fb3f612e))
* switch transaction events to server-side pagination ([b1e914f](https://github.com/qubic/explorer-frontend/commit/b1e914f809586f9775d36a50fc8da71eb2eb10b5))
* **tick:** extract shared transaction row components and add i18n keys ([6dbdcdf](https://github.com/qubic/explorer-frontend/commit/6dbdcdf01e02d6171aaa25dd96fc306c22a2e53c))

# [1.36.0-rc.1](https://github.com/qubic/explorer-frontend/compare/v1.35.0...v1.36.0-rc.1) (2026-04-02)
