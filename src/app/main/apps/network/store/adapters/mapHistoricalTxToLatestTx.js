// TODO: Verify if all fields are correctly mapped or if any additional fields are required
export default function mapHistoricalTxToArchiverTx(historicalTx) {
  return {
